...
import { Heart, MessageCircle, Share2, ArrowUpRight, ArrowDownRight, Send, MoreHorizontal } from "lucide-react";
  ...
  return (
    <div className="px-5 pt-14 pb-6 lg:pt-8">
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
        ...
        <p className="mt-1 text-sm text-muted-foreground">Recent transactions from the community</p>
      </motion.div>
