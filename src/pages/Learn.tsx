...
const modules = [
  { icon: Coins, title: "Compounding Visualized", description: "See how $100/month grows over 10, 20, and 30 years.", progress: 100, lessons: 4 },
  { icon: TrendingUp, title: "Credit vs Asset Growth", description: "Understand the difference between debt systems and wealth systems.", progress: 60, lessons: 5 },
  { icon: Shield, title: "Risk & Volatility", description: "What risk actually means and how to measure it in your portfolio.", progress: 30, lessons: 6 },
  { icon: PieChart, title: "Portfolio Construction", description: "Build a balanced portfolio using diversification principles.", progress: 0, lessons: 5 },
  { icon: BookOpen, title: "Long Term vs Short Term", description: "Compare time horizons and their impact on returns and taxes.", progress: 0, lessons: 4 },
];
    ...
    <div className="px-5 pt-14 pb-6 lg:pt-8">
      ...
      <div className="mt-6 space-y-3">
        {modules.map((mod, i) => {
          ...
          return (
            <motion.button key={mod.title} initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.05 * i + 0.2 }} className="glass-card w-full p-4 text-left transition-shadow hover:shadow-md">
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-2 flex items-center gap-2">
                    <div className="h-1 flex-1 overflow-hidden rounded-full bg-secondary">
                      <div className="h-full rounded-full bg-foreground transition-all" style={{ width: `${mod.progress}%` }} />
                    </div>
      ...
      <motion.div className="glass-card mt-5 p-4" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }}>
        <p className="text-xs leading-relaxed text-muted-foreground">
          ...
          <span className="italic">"In your TFSA, 78% is single-stock exposure. Let's simulate diversification impact."</span>
        </p>
      </motion.div>
    </div>
  );
