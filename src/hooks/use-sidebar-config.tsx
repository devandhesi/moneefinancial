...
const DEFAULT_LINKS: SidebarLink[] = [
  ...
  { id: "watchlist", path: "/watchlist", label: "Watchlist", icon: "Star", section: "main", visible: true, order: 3 },
  { id: "learn", path: "/learn", label: "Learn", icon: "BookOpen", section: "main", visible: true, order: 4 },
  { id: "transactions", path: "/transactions", label: "Transactions", icon: "Receipt", section: "secondary", visible: true, order: 5 },
  { id: "orders", path: "/orders", label: "Orders", icon: "ClipboardList", section: "secondary", visible: true, order: 6 },
  { id: "calendar", path: "/calendar", label: "Calendar", icon: "CalendarDays", section: "secondary", visible: true, order: 7 },
  { id: "simlab", path: "/simulation", label: "Sim Lab", icon: "FlaskConical", section: "secondary", visible: true, order: 8 },
  { id: "riskmap", path: "/risk", label: "Risk Map", icon: "Shield", section: "secondary", visible: true, order: 9 },
  { id: "social", path: "/social", label: "Social", icon: "Users", section: "secondary", visible: true, order: 10 },
  { id: "profile", path: "/profile", label: "Profile", icon: "User", section: "secondary", visible: true, order: 11 },
  { id: "settings", path: "/settings", label: "Settings", icon: "Settings", section: "secondary", visible: true, order: 12 },
];
